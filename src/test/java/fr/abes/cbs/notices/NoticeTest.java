...
class NoticeTest {
    ...
    void deleteSousZoneTest(){
        ...
        assertThat(notice.toString()).isEqualTo("");
    }
    ...
    void addSousZoneTest() throws Exception {
        ...
        assertThat(notice.toString()).isEqualTo("200 $atest$etoto$doooo\r");

        notice.addZone("200", "$a", "oih");
        notice.addSousZone("200", "$d", "ttt", "$a", "oih");
        assertThat(notice.toString()).isEqualTo("200 $atest$etoto$doooo\r200 $aoih$dttt\r");

        notice.addSousZone("200", "$e", "test", 1);
        assertThat(notice.toString()).isEqualTo("200 $atest$etoto$doooo\r200 $aoih$dttt$etest\r");
    }
    ...
    void addZoneTest() throws Exception {
        ...
        assertThat(notice.toString()).isEqualTo("200 $atest$etoto\r600 edit\r");

        notice.addZone("600", "$d", "uii");
        assertThat(notice.toString()).isEqualTo("200 $atest$etoto\r600 edit\r600 $duii\r");

        notice.addZone("540", "$h", "ty", "##".toCharArray());
        assertThat(notice.toString()).isEqualTo("200 $atest$etoto\r540 ##$hty\r600 edit\r600 $duii\r");

        Zone zone = new Zone("034", TYPE_NOTICE.BIBLIOGRAPHIQUE);
        zone.addSubLabel("$a", "test");
        notice.addZone(zone);
        assertThat(notice.toString()).isEqualTo("034 $atest\r200 $atest$etoto\r540 ##$hty\r600 edit\r600 $duii\r");
    }

    @DisplayName("Test toString Exemplaire")
    @Test
    void getStringExemplaire() throws Exception {
        notice = new Exemplaire("e01 $a31-01-19$bx");
